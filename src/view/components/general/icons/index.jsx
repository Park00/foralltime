        ...
        {checked === "all" && (
          <Col xl={4} md={8} span={12}>
            <Card
              ...
              className="da-text-center da-icon-card"
            >
              <i className={"da-text-color-dark-0 ri-2x ri-" + icon + "-line"} />
              <p className="da-badge-text">{icon}</p>
            </Card>
          </Col>
        )}
        ...
        {checked === "all" && (
          <Col xl={4} md={8} span={12}>
            <Card
              ...
              className="da-text-center da-icon-card"
            >
              <i className={"da-text-color-dark-0 ri-2x ri-" + icon + "-fill"} />
              <p className="da-badge-text">{icon}</p>
            </Card>
          </Col>
        )}
