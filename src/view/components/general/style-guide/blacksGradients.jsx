    ...
    <Card className="da-border-color-black-40">
        ...
        <Col>
          <Row className="da-border-radius da-overflow-hidden da-border-color-black-40">
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> Dark-Bg</p>
            </Col>
            ...
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-100</p>
            </Col>
            ...
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-80</p>
            </Col>
            ...
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-60</p>
            </Col>
            ...
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-40</p>
            </Col>
            ...
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-20</p>
            </Col>
            ...
            <Col>
              ...
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-10</p>
            </Col>

            <Col>
              <Tooltip title="B-0 #FFFFFF">
                <Col className="da-bg-color-black-10 da-color-wrapper da-border-radius-r da-mb-8"></Col>
              </Tooltip>
              <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0"> B-0</p>
            </Col>
          </Row>
        </Col>
      </Row>
      ...
      <Row gutter={24}>
        <Col>
          ...
          <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">
            Primary <br />
            Gradient
          </p>
        </Col>
