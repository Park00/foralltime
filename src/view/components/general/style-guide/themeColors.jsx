      ...
      <Card className="da-border-color-black-40">
        ...
        <Row className="da-mb-48">
          <Col lg={8} sm={8} md={8} xs={24}>
            ...
            <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">Primary</p>
          </Col>
          ...
          <Col lg={8} sm={8} md={8} xs={24}>
            ...
            <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">Secondary</p>
          </Col>
          ...
          <Col lg={8} sm={8} md={8} xs={24}>
            ...
            <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">Danger</p>
          </Col>
        </Row>
        ...
        <Row>
          <Col lg={8} sm={8} md={8} xs={24}>
            ...
            <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">Success</p>
          </Col>
          ...
          <Col lg={8} sm={8} md={8} xs={24}>
            ...
            <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">Warning</p>
          </Col>
          ...
          <Col lg={8} sm={8} md={8} xs={24}>
            ...
            <p className="da-badge-text da-text-color-black-100 da-text-color-dark-0">Info</p>
          </Col>
        </Row>
      </Card>
    </Col>
