  ...
  return (
    <Col className="da-px-0">
      ...
      <div className="da-mb-32">
        ...
        <p className="da-p1-body">
          All HTML headings,
          <span className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h1&gt;</span> through
          <span className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h6&gt;</span> are
          available.
        </p>
      </div>
      ...
      <Card className="da-border-color-black-40">
        ...
        <Row className="da-mb-24 da-border-bottom-1 da-border-color-dark-80">
          <Col span={12}>
            <p className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h1&gt; &lt;h1&gt;</p>
          </Col>
        ...
        <Row className="da-mb-24 da-border-bottom-1 da-border-color-dark-80">
          <Col span={12}>
            <p className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h2&gt; &lt;h2&gt;</p>
          </Col>
        ...
        <Row className="da-mb-24 da-border-bottom-1 da-border-color-dark-80">
          <Col span={12}>
            <p className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h3&gt; &lt;h3&gt;</p>
          </Col>
        ...
        <Row className="da-mb-24 da-border-bottom-1 da-border-color-dark-80">
          <Col span={12}>
            <p className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h4&gt; &lt;h4&gt;</p>
          </Col>
        ...
        <Row>
          <Col span={12}>
            <p className="da-text-color-primary-1 da-text-color-dark-primary-2">&lt;h5&gt; &lt;h5&gt;</p>
          </Col>
